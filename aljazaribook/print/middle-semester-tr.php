<?php /* Template Name: Middle Semester TR */ ?>
<?php get_header(); ?>
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/images/5-10-semester-1.jpg" as="image">
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/5-10-semester-2.jpg" as="image">
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/5-10-semester-3.jpg" as="image">
					...
					<div id="printArea" class="card dark:bg-zinc-800 dark:border-zinc-600">
						...
						if (!empty($group_users)) {
							foreach ($group_users as $key => $value) {
								...
								?>
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/5-10-semester-1-tr.jpg" />
								...
								<div class="card_div">
									...
									<?php if ($blog_id == 31): ?>
										<div class="candidate">
											<img style="max-width: 100%;" src="<?php echo get_template_directory_uri(); ?>/print/img/candidate.jpg" alt="">
										</div>
									<?php endif ?>
								</div>
								<div class="card_div">
									...
									<img style="width: 100%;" src="<?php echo get_template_directory_uri(); ?>/print/img/5-10-semester-3.jpg" alt="5-10 Giris Resmi">
									<div class="subject_list">
										<?php 
										$basiliabilir = [];
										$sort_subjecets = [];
										foreach ($sonuclar1 as $subject => $subjectlerkon) {
										...
										foreach ($unique_subject_ids as $key_subject => $subject_id) {
											if ($basiliabilir[$subject_id] != 0) {
												...
												if (get_field("select_lesson_type",$subject_id)[0]->post_title != "QURAN") {
								...
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/5-10-semester-4.jpg" />
									<div class="sayfalar_ust_isim">
										<h5 style="color: #818285;" class="font_gl">
											<?php echo $get_user_data['first_name'][0]; ?> <?php echo $get_user_data['last_name'][0]; ?>
										</h5>
				...
				series: [{
					...
					data: [
						...
						foreach ($ogrenci_ders_isimleri[$key] as $keys => $values) {
							if (get_field("select_lesson_type",$values)[0]->post_title != "QURAN") {
								echo "'";
