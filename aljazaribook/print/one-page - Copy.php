							...
							foreach ($group_users as $key => $value) {
								...
								<div class="card_div">
									...
									<div class="subject_info">
										<?php  
										foreach ($gruoup_subjects as $keys => $values) {
											$select_lesson_type = get_field("select_lesson_type",$values->ID);
											?>
											<div class="subject_row">
												...
												<div class="subject_point font_gb">
													<?php  
													// $bg_table_name = "student_avarages";
													// $query = $wpdb->prepare("SELECT * from $bg_table_name where bloog_id =".$blog_id." and group_id =".$class." and subjecet_id =".$values->ID." and quarter_id = ".$quarter." and student_id =".$value['ID']."" );
													// $sonuclar1 = $wpdb->get_results($query);
