<?php /* Template Name: Primary Semester TR */ ?>
<?php get_header(); ?>
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-1-tr.jpg" as="image">
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-2.jpg" as="image">
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-3-tr.jpg" as="image">
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-4-tr.jpg" as="image">
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-5-tr.jpg" as="image">
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-6-tr.jpg" as="image">
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-7-tr.jpg" as="image">
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-8-tr.jpg" as="image">
					...
					<div id="printArea" class="card dark:bg-zinc-800 dark:border-zinc-600">
						...
						if (!empty($group_users)) {
							foreach ($group_users as $key => $value) {
								...
								<!-- 1. sayfa -->
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-1-tr.jpg" />
								...
								<!-- 3. sayfa -->
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-3-tr.jpg" />
										...
										foreach ($sonuclar1 as $subject => $subjectler) {
											if (get_field("select_lesson_type",$subjectler->subjecet_id)[0]->post_title == "ENGLISH") {
												...
												<div class="subject_com_en">
													...
													echo get_student_comment_easy($subjectler->subjecet_id,$quarter,$value['ID'],'subject_comment')[0]->comment;
													?>
												</div>
												<?php 
											}
								...
								<!-- 4. sayfa -->
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-4-tr.jpg" />
									<div class="sayfa_3_top_2 font_gb">
										<?php echo $get_user_data['first_name'][0]; ?> <?php echo $get_user_data['last_name'][0]; ?>, <?php echo get_the_title($class); ?>
										<br>
										<?php echo $quarter_yazisi; ?>, <?php echo $school_year; ?> Student Report
								...
								<!-- 5. sayfa -->
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-5-tr.jpg" />
									<div class="sayfa_3_top_2 font_gb">
										<?php echo $get_user_data['first_name'][0]; ?> <?php echo $get_user_data['last_name'][0]; ?>, <?php echo get_the_title($class); ?>
										<br>
										<?php echo $quarter_yazisi; ?>, <?php echo $school_year; ?> Student Report
								...
								<!-- 6. sayfa -->
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-6-tr.jpg" />
									<div class="sayfa_3_top_2 font_gb">
										<?php echo $get_user_data['first_name'][0]; ?> <?php echo $get_user_data['last_name'][0]; ?>, <?php echo get_the_title($class); ?>
										<br>
										<?php echo $quarter_yazisi; ?>, <?php echo $school_year; ?> Student Report
								...
								<!-- 7. sayfa -->
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-7-tr.jpg" />
									<div class="sayfa_3_top_2 font_gb">
										<?php echo $get_user_data['first_name'][0]; ?> <?php echo $get_user_data['last_name'][0]; ?>, <?php echo get_the_title($class); ?>
										<br>
										<?php echo $quarter_yazisi; ?>, <?php echo $school_year; ?> Student Report
								...
								<!-- 8. sayfa -->
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-8-tr.jpg" />
									<div class="sayfa_3_top_2 font_gb">
										<?php echo $get_user_data['first_name'][0]; ?> <?php echo $get_user_data['last_name'][0]; ?>, <?php echo get_the_title($class); ?>
										<br>
										<?php echo $quarter_yazisi; ?>, <?php echo $school_year; ?> Student Report
