<?php /* Template Name: Atar Semester TR */ ?>
<?php get_header(); ?>
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/11-12-semester-1-tr.jpg" as="image">
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/5-10-semester-2.jpg" as="image">
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/11-12-semester-3-tr.jpg" as="image">
					...
					<div id="printArea" class="card dark:bg-zinc-800 dark:border-zinc-600">
						...
						if (!empty($group_users)) {
							foreach ($group_users as $key => $value) {
								...
								?>
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/11-12-semester-1-tr.jpg" />
								...
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/5-10-semester-2.jpg" />
								...
								<div class="card_div">
									...
									<div class="sayfa_3_top font_gb">
										• <?php echo $quarter_yazisi; ?> GRADES
									</div>
									<img style="width: 100%;" src="<?php echo get_template_directory_uri(); ?>/print/img/11-12-semester-3-tr.jpg" alt="5-10 Giris Resmi">
														...
														<div class="subject_mark">
															...
															if (!empty($student_curv_point)) {
																if ($student_curv_point*2 < 50) {
																	...
																	$rakam_karsiligi = "D";
																}elseif($student_curv_point*2 < 70 && $student_curv_point*2 > 59){
																	$rakam_karsiligi = "C";
																}elseif($student_curv_point*2 < 77 && $student_curv_point*2 > 69){
																	$rakam_karsiligi = "C+";
																}elseif($student_curv_point*2 < 86 && $student_curv_point*2 > 76){
																	$rakam_karsiligi = "B";
																}elseif($student_curv_point*2 < 90 && $student_curv_point*2 > 85){
																	$rakam_karsiligi = "B+";
																}elseif($student_curv_point*2 < 97 && $student_curv_point*2 > 89){
																	$rakam_karsiligi = "A";
																}elseif($student_curv_point*2 > 96){
																	$rakam_karsiligi = "A+";
																}
															}
													...
													<div class="sene_sonu">
														<div class="subject_grade">
															...
															if ($quarter == 4) {
																...
																echo $final_not = number_format($final_not,1);
									...
									<div class="grid grid-cols-1 xl:grid-cols-12 gap-5 grafik">
										<div class="col-span-8">
											<div id="student_report_<?php echo $key; ?>" data-colors='["#d69929", "#244b5a"]' class="apex-charts w-full" dir="ltr"></div>
										</div>
									</div>
									<!-- grafik alani bitis -->
								</div>
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/11-12-semester-4-tr.jpg" />
									<div class="sayfalar_ust_isim">
										<h5 style="color: #818285;" class="font_gl">
											<?php echo $get_user_data['first_name'][0]; ?> <?php echo $get_user_data['last_name'][0]; ?>
										</h5>
...
<script>
	...
	$(document).ready(function(){
		...
		foreach ($group_users as $key => $value) {
			?>
			var columnColors = getChartColorsArray("#student_report_<?php echo $key; ?>");
			var options = {
				chart: {
					height: 300,
					type: 'bar',
				...
				series: [{
					...
					data: [
						<?php  
						foreach ($ogrenci_ders_isimleri[$key] as $keys => $values) {
							$atar = get_field("atar",$values);
							echo "'";
							if ($atar === "Yes") {
								echo number_format(($student_notlari_genel[$key][$keys][1] + $student_notlari_genel[$key][$keys][2])*2,1);
							}else{
								echo number_format(($student_notlari_genel[$key][$keys][1] + $student_notlari_genel[$key][$keys][2])/2,1);
							}
							echo "',";
					...
					data: [
						...
						if ($quarter == 4) {
							foreach ($ogrenci_ders_isimleri[$key] as $keys => $values) {
								...
								echo "'";
								if ($atar === "Yes") {
									echo number_format(($student_notlari_genel[$key][$keys][3] + $student_notlari_genel[$key][$keys][4])*2,1);
								}else{
									echo number_format(($student_notlari_genel[$key][$keys][3] + $student_notlari_genel[$key][$keys][4])/2,1);
								}
								echo "',";
				...
				xaxis: {
					categories: [
						...
						foreach ($ogrenci_ders_isimleri[$key] as $keys => $values) {
							echo "'";
							echo get_field("select_lesson_type",$values)[0]->post_title;
							echo "',";
						}
						?>
						],
			...
			var chart = new ApexCharts(
				document.querySelector("#student_report_<?php echo $key; ?>"),
				options
				);
