<?php /* Template Name: Atar Semester */ ?>
<?php get_header(); ?>
					...
					<div id="printArea" class="card dark:bg-zinc-800 dark:border-zinc-600">
						...
						if (!empty($group_users)) {
							foreach ($group_users as $key => $value) {
								...
								?>
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/11-12-semester-1.jpg" />
								...
								<div class="card_div">
									...
									<img style="width: 100%;" src="<?php echo get_template_directory_uri(); ?>/print/img/11-12-semester-3.jpg" alt="5-10 Giris Resmi">
											...
											<div class="semester_2">
												<div class="subject_grade">
													...
													if ($quarter == 4) {
														...
														echo $student_curv_point = $semester_gpa_2;
													}
													?>
												</div>
												<div class="subject_mark">
