<?php /* Template Name: Primary Semester */ ?>
<?php get_header(); ?>
...
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-4.jpg" as="image">
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-5.jpg" as="image">
					...
					<div id="printArea" class="card dark:bg-zinc-800 dark:border-zinc-600">
						...
						if (!empty($group_users)) {
							foreach ($group_users as $key => $value) {
								...
								<!-- 4. sayfa -->
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-4.jpg" />
									<div class="sayfa_3_top_2 font_gb">
										<?php echo $get_user_data['first_name'][0]; ?> <?php echo $get_user_data['last_name'][0]; ?>, <?php echo get_the_title($class); ?>
										<br>
										<?php echo $quarter_yazisi; ?>, <?php echo $school_year; ?> Student Report
								...
								<!-- 5. sayfa -->
								<div class="card_div">
									<img style="width: 100%" src="<?php echo get_template_directory_uri(); ?>/print/img/primary-semster-5.jpg" />
									<div class="sayfa_3_top_2 font_gb">
										<?php echo $get_user_data['first_name'][0]; ?> <?php echo $get_user_data['last_name'][0]; ?>, <?php echo get_the_title($class); ?>
										<br>
										<?php echo $quarter_yazisi; ?>, <?php echo $school_year; ?> Student Report
