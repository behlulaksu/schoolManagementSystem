...
<!-- Plugins js-->
<script src="<?php echo get_template_directory_uri(); ?>/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/assets/libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js"></script>
<!-- dashboard init -->
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/pages/dashboard.init.js"></script>

<script src="<?php echo get_template_directory_uri(); ?>/assets/js/pages/nav&tabs.js"></script>

<script src="<?php echo get_template_directory_uri(); ?>/assets/libs/swiper/swiper-bundle.min.js"></script>

<script src="<?php echo get_template_directory_uri(); ?>/assets/js/pages/login.init.js"></script>
