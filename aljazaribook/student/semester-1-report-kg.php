<?php /* Template Name: Semester 1 Report KG */ ?>
<?php get_header(); ?>


<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/images/kg-4-sayfa1.jpg" as="image">
				...
				<div class="col-span-12 xl:col-span-12">
					<div class="card dark:bg-zinc-800 dark:border-zinc-600">
						<div id="printableArea" style="position: relative; height: 70vh; overflow-y: scroll;">
							...
							<div class="ilk_sayfa">
								<img style="width: 100vw; height:100vh; " src="<?php echo get_template_directory_uri(); ?>/images/kg-4-sayfa1.jpg" alt="5-10 Giris Resmi">
								<div class="ilk_sayfa_isimlar">
									<h3 class="font_gbook"><?php echo $get_user_data['first_name'][0]; ?> <?php echo $get_user_data['last_name'][0]; ?></h3>
									<h3 class="font_gbook"><?php echo get_field('grade', 'user_'.$student); ?></h3>
							...
							<div class="ucuncu_sayfa">
								<div style="display: flex;">
									<img style="width: 15vw; margin-left: 6%; margin-top: 3%; margin-right: 10px;" src="<?php echo get_template_directory_uri(); ?>/images/kg-4-sayfa3.png" alt="5-10 Giris Resmi">
								...
								?>
								<!-- kopyalanan yer bitis -->
								<img style="width: 100%; position: absolute; bottom: 0; left: 0%;" src="<?php echo get_template_directory_uri(); ?>/images/kg-4-sayfa3-footer.png" alt="5-10 Giris Resmi">
							</div>
