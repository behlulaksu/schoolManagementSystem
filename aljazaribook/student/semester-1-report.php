<?php /* Template Name: Semester 1 Report Card */ ?>
<?php get_header(); ?>


<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/images/5-10-sayfa1.png" as="image">
				...
				<div class="col-span-12 xl:col-span-12">
					<div class="card dark:bg-zinc-800 dark:border-zinc-600">
						<div id="printableArea" style="position: relative; height: 70vh; overflow-y: scroll;">
							<div class="ilk_sayfa">
								<img style="width: 100vw; height:100vh; " src="<?php echo get_template_directory_uri(); ?>/images/5-10-sayfa1.png" alt="5-10 Giris Resmi">
											...
											<div class="not_alanlari" style="display: flex;">
												...
												<div class="dis_flex" style="width: 25%;">
													<div style="display: flex; width: 100%;">
														...
														<div class="border_left" style="width: 50%; text-align: center; padding: 12px; font-size: 10px; text-align: center;font-family:'Gotham Bold','Gotham Book',sans-serif; min-height: 12px; font-weight: bold;">
															<?php 
															echo $ogrenci_all_marks[$sayma] = number_format($student_curv_point, 2, '.', ''); 
											...
											<div class="not_alanlari" style="display: flex;">
												...
												<div class="dis_flex" style="width: 25%;">
													<div style="display: flex; width: 100%;">
														...
														<div class="border_left" style="width: 50%; text-align: center; padding: 12px; font-size: 10px; text-align: center;font-family:'Gotham Bold','Gotham Book',sans-serif; min-height: 12px; font-weight: bold;">
															<?php echo $ogrenci_all_marks[$sayma] = number_format($student_curv_point, 2, '.', ''); 
															$credit_not_toplama = $credit_not_toplama + ($student_curv_point * $subject_credit)
															?>
														</div>
													</div>
								...
								<div class="ucuncu_sayfa_table_footer">
									<div class="not_alanlari" style="display: flex; border-bottom: 5px solid #d79a2a !important;">
										<div class="dis_flex border_left font_gb" style="width: 47.7%; background-color: #244b5a !important; color: #fff; font-weight: bold; justify-content: flex-start !important; padding-left: 15px; height: 35px;">
											SEMESTERLY GRADE POINT AVERAGE
										</div>
										<?php $sonuc_not = ($credit_not_toplama / $toplam_credit); ?>
										<div class="dis_flex" style="width: 25%;">
											<div style="display: flex; width: 100%;">
												<div class="border_left" style="width: 50%; text-align: center; padding: 12px; font-size: 10px; text-align: center; font-family:'Gotham Book','Gotham Light','Gotham Bold',sans-serif; background-color: #244b5a !important; color: #fff; font-weight: bold; min-height: 12px; font-weight: 800;">
													<?php  
													if ($sonuc_not < 50) {
														$rakam_karsiligi = "E";
												...
												<div class="border_left" style="width: 50%; text-align: center; padding: 12px; font-size: 10px; text-align: center;font-family:'Gotham Book','Gotham Light','Gotham Bold',sans-serif; background-color: #244b5a !important; color: #fff; font-weight: bold; min-height: 12px; font-weight: 800;">
													<?php echo number_format($sonuc_not, 2, '.', ''); ?>
												</div>
											</div>
										</div>
										<div class="dis_flex" style="width: 25%;">
