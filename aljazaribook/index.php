        ...
        <div class="container-fluid px-[0.625rem]">
            ...
            <div class="grid grid-cols-12 gap-5">
                ...
                <div class="col-span-12 xl:col-span-12">
                    <?php  
                    $class_advisors_students = [];
                    $class_advisors_classes = [];
                    $args = array(
                        'post_type' => 'user_groups',
                        'meta_query' => array(
                            array(
                    ...
                    if ($my_posts->have_posts()) {
                        while ($my_posts->have_posts()) {
                            ...
                            $categoryID = get_the_id(); 
                            /**/
                            array_push($class_advisors_classes,get_the_title());
                            $students = get_field("group_users",get_the_id());
                            foreach ($students as $key => $value) {
                                array_push($class_advisors_students, $value['ID']);
                            }
                            /**/
                        }
                    }
                    ...
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <div class="card-body pb-0">
                            <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100" style="color: #8e1838 !important;">
                                Advisor Classes (
                                    <?php  
                                    foreach ($class_advisors_classes as $key => $value) {
                                        echo $value;
                                        echo " ";
                                    }
                                    ?>
                            ...
                            <div class="card-body"> 
                                <div class="relative overflow-x-auto">
                                    <table class="w-full text-sm text-left text-gray-500 ">
                                        <thead class="text-sm text-gray-700 dark:text-gray-100 bg-gray-50 dark:bg-zinc-600" style="background-color: #d79a2a !important; color: #8e1838 !important;">
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            $student_ids = implode(',', array_map('intval', $class_advisors_students)); 
                                            $query = $wpdb->prepare("SELECT * FROM $bg_table_name WHERE domain_id = %d AND student_id IN ($student_ids) AND delete_status = 0 ORDER BY id DESC LIMIT 20", $blog_id);
                                            $sonuclar1 = $wpdb->get_results($query);

                                            foreach ($sonuclar1 as $key => $value) {
                                                ?>
                                                <tr style="border: 1px solid;" class="bg-white border-b border-gray-50 dark:bg-zinc-700 dark:border-zinc-600">
                                                    <th scope="row" class="px-6 py-3.5 font-medium text-gray-900 whitespace-nowrap dark:text-zinc-100">
                                                        <?php  
                                                        $teacher = get_user_meta($value->student_id);
                                                                        ...
                                                                        for ($a=0; $a < $ders_sayisis; $a++) { 
                                                                            if ($lesson_idler[3][$a] === "Monday") {
                                                                                ...
                                                                                if ($dizi == $i) {
                                                                                    ...
                                                                                    $class_asc_id = get_title_by_meta("class_asc_id", $lesson_idler[2][$a],$lesson_idler[1][$a]);
