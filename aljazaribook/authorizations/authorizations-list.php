<?php /* Template Name: Authorizations List */ ?>
<?php get_header(); ?>
									...
									foreach ($users as $key => $value) {
										...
										<tr>
											...
											<td class="p-4 pr-8 border border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">
												<a href="mailto:<?php echo $value->data->user_email; ?>">
													<?php 
													$user_info_role = $value;
													if ($user_info_role) {
														$user_roles = $user_info_role->roles[0];
														if (empty($user_roles)) {
											...
											<td class="p-4 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">
												<a target="_Blank" href="<?php echo get_site_url(); ?>/authorizations-edit?user=<?php echo $value->data->ID; ?>">
