<?php /* Template Name: Class Objectives */ ?>
<?php get_header(); ?>
		...
		<div class="container-fluid px-[0.625rem]">
			<div class="grid grid-cols-1 mb-5">
				<div class="flex items-center justify-between">
					<h4 class="mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100">My Class Objectives</h4>
				</div>
			</div>
			<div class="grid grid-cols-1 lg:grid-cols-12 gap-5 mt-5">
				...
				if ($my_posts->have_posts()) {
					while ($my_posts->have_posts()) {
						...
						?>
						<a href="<?php echo get_site_url(); ?>/objectives-details?classid=<?php echo get_the_id(); ?>" class="col-span-12 xl:col-span-3">
